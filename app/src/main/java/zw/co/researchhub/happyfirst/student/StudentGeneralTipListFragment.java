package zw.co.researchhub.happyfirst.student;
...
public class StudentGeneralTipListFragment extends Fragment {
    ...
    public static StudentGeneralTipListFragment newInstance() {
        return new StudentGeneralTipListFragment();
    }
